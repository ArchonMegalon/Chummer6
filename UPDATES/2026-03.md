...
### 2026-03-24 · Publish rolling desktop release assets.

- Surface: Workbench
- Source push: `Publish rolling desktop release assets`
- What changed for you: The visible Chummer surface moved a little, even if most of the work is still beneath the floorboards.
- Still not promised: that any visible surface is finished, stable, or something you should bet a session on.
...
- Surface: chummer.run
- Source push: `Tighten Hub participation anchors and hover states`
...
### 2026-03-24 · Reframe Chummer as a proof-first product front.

- Surface: Design
- Source push: `Reframe Chummer as a proof-first product front`
- What changed for you: The public-facing rules for what Chummer should expose got less contradictory.
- Still not promised: that any visible surface is finished, stable, or something you should bet a session on.

### 2026-03-24 · Recast Hub as a proof-first product front.

- Surface: chummer.run
- Source push: `Recast Hub as a proof-first product front`
- What changed for you: The public-facing shell moved a little closer to behaving like a real front door instead of a clever stub.
- Still not promised: that any visible surface is finished, stable, or something you should bet a session on.
---
