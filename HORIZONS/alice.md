...
Builders get concrete what-if checks instead of vague assistant advice.
...
There is an early version you can try. It is useful enough to learn from and still rough enough that feedback matters. The next useful work is clearer controls, better fit for real tables, and fewer edge-case surprises.
