...
> **An explainable Shadowrun campaign OS.**
>
> Chummer6 is the human-facing Shadowrun campaign OS for rulings, prep, and campaign continuity that show their work instead of hiding the math.
...
The project is building visible reasoning instead of trust-me table lore. The public surface gives you the guide, the status readout, future lanes, support paths, and proof artifacts where they are ready to inspect.
