...
![Parts overview banner](../assets/pages/parts-index.png)
                ...
                The parts mostly describe how the idea would eventually split if it ever hardens into software.

                Use the part map as a conceptual diagram, not as evidence that all of those layers already exist in a usable form. If a part seems to have a visible artifact, treat that as an exception.
