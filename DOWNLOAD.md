...
- Claim boundary: That stronger wording only belongs on the main release surfaces that meet the current public expectations; preview artifacts, proof cards, captions, packet siblings, artifact-factory explainers, and fallback routes do not inherit it just by sitting nearby.
